...
Module AccesoDatos
    ...
    'Public conexion As New SqlConnection("data source=m201-30; initial catalog= gestion_bibliografia; uid=sa ; pwd=@lumno123")
    ...
    ' Public conexion As New SqlConnection("data source =LAPTOP-Q9SUVL2I\SQLEXPRESS; initial catalog = gestion_bibliografia; user=sa; password=@lumno123")

    Public conexion As New SqlConnection("data source=DESKTOP-DHPDRLI;initial catalog=gestion_bibliografia;uid=sa;pwd=Mddp091821")
    ...
    'Procedimiento para insertar, eliminar y actualizar un registro en la base de datos
    ...
    'Procedimiento para Confirmar una Transacción
